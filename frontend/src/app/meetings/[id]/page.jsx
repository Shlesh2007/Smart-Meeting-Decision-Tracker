                              ...
                              <div className="flex justify-between items-start">
                                <div className="space-y-1">
                                  ...
                                  <div className="flex items-center space-x-3 text-xs text-slate-500 pt-1">
                                    ...
                                    <span>•</span>
                                    <span>Due Date: <strong className={action.is_overdue ? 'text-rose-600' : ''}>{action.due_date ? new Date(action.due_date).toLocaleDateString('en-US', { month: 'short', day: '2-digit', year: 'numeric' }) : 'N/A'}</strong></span>
                                  </div>
