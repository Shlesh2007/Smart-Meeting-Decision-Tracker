  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="border border-slate-200/80 dark:border-slate-700/80 rounded-2xl shadow-xs hover:shadow-md transition-all duration-200 dark:bg-slate-800">
        ...
        <Card className="border border-rose-200/80 dark:border-rose-900/50 bg-rose-50/30 dark:bg-rose-950/20 rounded-2xl shadow-xs hover:shadow-md transition-all duration-200">
          <div className="flex items-center justify-between">
